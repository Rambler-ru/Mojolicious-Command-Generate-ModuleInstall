...
Mojolicious::Command::Generate::Makefile::MI - Module::Install Makefile Generator Command

=head1 SYNOPSIS

    use Mojolicious::Command::Generate::Makefile::MI;

    my $makefile = Mojolicious::Command::Generate::Makefile::MI->new;
    $makefile->run(@ARGV);
